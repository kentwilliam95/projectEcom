                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <a href=<?php echo site_url("chome/tobasket")?>><i class="fa fa-list"></i> My orders</a>
                                </li>
                                <li>
                                    <a href=<?php echo site_url("chome/towish")?>><i class="fa fa-heart"></i> My wishlist</a>
                                </li>
                                <li class="active">
                                    <a href="#"><i class="fa fa-user"></i> My Account</a>
                                </li>
                                <li>
                                    <a href=<?php echo site_url("chome/index")?>><i class="fa fa-home"></i> Home</a>
                                </li>
                                 <li>
                                    <a href=<?php echo site_url("chome/logout")?>><i class="fa fa-sign-out"></i> Logout</a>
                                </li>
                            </ul>
                        </div>
